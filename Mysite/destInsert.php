...
<body>
   <form action="" method="post">
      ...
      <table align = "center" width="500px" border="1px" style="color:white;">
          ...
          <tr>
              <td align="center">Destination Visited</td>
              <td><input type="text" name="visi"></td>
          </tr>
           <tr>
              <td align="center">PMDC location</td>
              <td><input type="text" name="pmd"></td>
          </tr>
           <tr>
              <td align="center">Discreption</td>
              <td><input type="text" name="disc"></td>
          </tr>
          
          <tr><td><a href="adminDestination.php"><input type = "submit" name="submit" value = "Insert"></a></td></tr>
...
if(isset($_POST['submit'])){
    ...
    $query = mysql_query ("insert into disti (`Name`,`visited`,`PMDC`,`Descroption`) values ('$name','$visited','$pmdc','$Disc')");
