...
mysql_select_db("event");
          ...
          <tr>
            ...
            <td align="center"><?php echo  $desc; ?></td>
              ...
              <td align="center"><a href="distidelete.php?del=<?php echo $id;?>">DELETE</a></td>  
               <td align="center"><a href="destiedit.php?edit=<?php echo $id;?>">EDIT</a></td>
          </tr>
          <?php
          }
          ?>
      </table><br><br>        
<a href="destInsert.php" style="margin-left:700px;"><input type = "submit" name="submit" value = "insert New Event"></a>
